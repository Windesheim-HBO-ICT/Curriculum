...
class WebNavbar extends HTMLElement {
  ...
  constructor() {
    ...
    this.shadowRoot.querySelectorAll(".hbo-i-tag").forEach((tag) => {
      tag.addEventListener("click", () => {
        const activiteiten = tag.nextElementSibling;
        ...
        const itemsContainer = tag.closest(".hbo-i-items");
        itemsContainer
    ...
    // Add event listeners to hbo-i-activiteit elements to toggle visibility of hbo-i-vaardigheden
    this.shadowRoot
      .querySelectorAll(".hbo-i-activiteit")
      .forEach((activiteit) => {
        activiteit.addEventListener("click", () => {
          const vaardigheden = activiteit.querySelector(".hbo-i-vaardigheden");
